  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow:
          "0 0 0 1px oklch(0.68 0.14 158 / 0.3), 0 8px 24px -4px oklch(0.62 0.14 158 / 0.45)",
      }}
    >
      <span
      ...
      <div className="min-h-screen lg:grid lg:grid-cols-2" style={{ background: "#070c18" }}>
        ...
        >
          ...
          <motion.div
            ...
            style={{
              background:
                "radial-gradient(circle, oklch(0.68 0.14 158 / 0.18) 0%, transparent 70%)",
            }}
          ...
          <motion.div
            ...
            style={{
              background:
                "radial-gradient(circle, oklch(0.68 0.14 210 / 0.15) 0%, transparent 70%)",
            }}
          ...
          <motion.div
            ...
            style={{
              background:
                "radial-gradient(circle, oklch(0.58 0.14 290 / 0.10) 0%, transparent 70%)",
            }}
          ...
          <div className="relative space-y-8 max-w-md">
            ...
            <p className="text-base text-white/60 leading-relaxed">{t("auth.hero.subtitle")}</p>
        ...
        <main className="relative flex flex-col min-h-screen lg:min-h-0 overflow-hidden">
          ...
          <motion.div
            ...
            style={{
              background:
                "radial-gradient(circle, oklch(0.68 0.14 158 / 0.09) 0%, transparent 70%)",
            }}
            animate={{ opacity: [0.5, 0.9, 0.5], scale: [1, 1.06, 1] }}
          ...
          <motion.div
            ...
            style={{
              background:
                "radial-gradient(circle, oklch(0.58 0.14 290 / 0.07) 0%, transparent 70%)",
            }}
          ...
          >
            <Link to="/auth" className="flex items-center gap-2.5 lg:hidden">
              ...
              <span className="text-white font-bold text-lg" style={{ letterSpacing: "-0.025em" }}>
                NOOLY
              </span>
            </Link>
                  ...
                  <>
                    ...
                    <form onSubmit={submit} noValidate className="space-y-3.5">
                          ...
                          {usernamePreview && (
                            ...
                            >
                              <AtSign
                                ...
                                style={{ color: "oklch(0.75 0.14 158)" }}
                              />
                      ...
                      <button
                        ...
                        style={{
                          background:
                            "linear-gradient(135deg, oklch(0.68 0.14 158), oklch(0.56 0.13 175))",
  ...
  return (
    <div className="text-center space-y-6">
      ...
      <div>
        ...
        <p className="text-white/45 mt-2 leading-relaxed text-sm">{t("auth.checkInbox")}</p>
      </div>
      ...
      {username && (
        ...
        >
          ...
          <p className="text-[11px] text-white/30 leading-relaxed">{t("auth.username.note")}</p>
        </div>
      )}
